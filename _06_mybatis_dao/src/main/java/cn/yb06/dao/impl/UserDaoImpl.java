package cn.yb06.dao.impl;

import cn.yb06.dao.IUserDao;
import cn.yb06.domain.User;
...
public class UserDaoImpl implements IUserDao {
    ...
    public List<User> findAll() {
        ...
        List<User> users = session.selectList("cn.yb06.dao.IUserDao.findAll");//参数就是能获取配置信息的key
        //3.释放资源
        session.close();
        return users;
    }
